...
const Footer = () => {
  return (
    <footer style={{
      ...
      className="px-6 md:px-16 lg:px-24 pt-20 pb-10"
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-12 lg:gap-16 mb-16">
        ...
        <div className="md:col-span-2 lg:col-span-1">
          ...
          <p className="text-[0.68rem] leading-[1.95] mb-8 tracking-[0.03em]"
        ...
        <div>
          ...
          <ul className="flex flex-col gap-[1.1rem] list-none">
            {["Our Story", "Sustainability", "Press", "Careers", "Affiliates"].map((item) => (
              <li key={item}>
                <Link to="/about" className="text-[0.72rem] no-underline tracking-[0.03em] transition-colors duration-300"
                  style={{ color: "var(--text-muted)" }}
                  onMouseEnter={e => e.currentTarget.style.color = "var(--gold-light)"}
                  onMouseLeave={e => e.currentTarget.style.color = "var(--text-muted)"}
                >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 flex-wrap">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-10">
          {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((item) => (
            <a key={item} href="#"
              className="text-[0.6rem] no-underline tracking-[0.08em] transition-colors duration-300"
              style={{ color: "var(--text-muted)" }}
