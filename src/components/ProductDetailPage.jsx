...
const allProducts = [
  { id: 1,  name: "Silk Wrap Dress",        price: 285, oldPrice: null, badge: "New",        badgeStyle: "bg-[#c9a96e] text-[#0a0806]", category: "women",       bg: "bg-[#1c1610]", description: "A fluid silk wrap dress cut for the modern woman. Designed with an adjustable tie waist and deep V-neckline, this piece transitions effortlessly from day to evening.", material: "100% Silk", care: "Dry clean only", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 2,  name: "Tailored Blazer",         price: 195, oldPrice: 320, badge: "Sale",       badgeStyle: "bg-[#b83a2a] text-[#f5efe6]", category: "men",         bg: "bg-[#171310]", description: "A sharp single-breasted blazer crafted from premium wool blend. Clean lapels and a structured shoulder make this a cornerstone of any refined wardrobe.", material: "80% Wool, 20% Polyester", care: "Dry clean only", sizes: ["S", "M", "L", "XL", "XXL"] },
  { id: 3,  name: "Linen Wide-Leg Trousers", price: 165, oldPrice: null, badge: null,        badgeStyle: null,                          category: "women",       bg: "bg-[#1a1510]", description: "Relaxed wide-leg trousers in breathable linen. A high-rise waist and side pockets combine comfort with elegance for warm-weather dressing.", material: "100% Linen", care: "Machine wash cold, hang dry", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 4,  name: "Cashmere Knit Midi",      price: 340, oldPrice: null, badge: "Bestseller",badgeStyle: "bg-[#c9a96e] text-[#0a0806]", category: "new",         bg: "bg-[#1e1812]", description: "A luxuriously soft cashmere midi dress with ribbed knit detailing. Designed to drape beautifully, it offers warmth without compromising silhouette.", material: "100% Grade A Cashmere", care: "Hand wash cold or dry clean", sizes: ["XS", "S", "M", "L"] },
  { id: 5,  name: "Draped Satin Blouse",     price: 145, oldPrice: null, badge: "New",       badgeStyle: "bg-[#c9a96e] text-[#0a0806]", category: "new",         bg: "bg-[#191510]", description: "A satin blouse with an elegant draped front and loose fit. Wear it tucked into tailored trousers or open over a slip for a layered look.", material: "95% Polyester Satin, 5% Elastane", care: "Machine wash gentle cycle", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 6,  name: "Wool Overcoat",           price: 520, oldPrice: 680, badge: "Sale",       badgeStyle: "bg-[#b83a2a] text-[#f5efe6]", category: "men",         bg: "bg-[#141210]", description: "A classic double-breasted overcoat in a heavy wool blend. Structured shoulders, a clean back vent, and a full lining make this the definitive winter coat.", material: "70% Wool, 20% Polyamide, 10% Cashmere", care: "Dry clean only", sizes: ["S", "M", "L", "XL"] },
  { id: 7,  name: "Pleated Midi Skirt",      price: 210, oldPrice: null, badge: null,        badgeStyle: null,                          category: "women",       bg: "bg-[#1b1612]", description: "A flowing pleated midi skirt with a hidden side zip. The movement of the fabric creates an effortlessly graceful silhouette for any occasion.", material: "100% Viscose", care: "Dry clean recommended", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 8,  name: "Structured Tote Bag",     price: 390, oldPrice: null, badge: "Bestseller",badgeStyle: "bg-[#c9a96e] text-[#0a0806]", category: "accessories", bg: "bg-[#171310]", description: "A minimal structured tote in full-grain leather. Spacious enough for daily essentials with an interior zip pocket and magnetic closure.", material: "Full-grain leather", care: "Wipe clean with dry cloth", sizes: ["One Size"] },
  { id: 9,  name: "Velvet Evening Gown",     price: 620, oldPrice: null, badge: "New",       badgeStyle: "bg-[#c9a96e] text-[#0a0806]", category: "women",       bg: "bg-[#1d1612]", description: "A floor-length velvet gown with a fitted bodice and sweeping skirt. Crafted for evenings that demand presence.", material: "90% Polyester Velvet, 10% Elastane", care: "Dry clean only", sizes: ["XS", "S", "M", "L"] },
  { id: 10, name: "Merino Turtleneck",       price: 175, oldPrice: null, badge: null,        badgeStyle: null,                          category: "men",         bg: "bg-[#161412]", description: "A slim-fit turtleneck in superfine merino wool. Lightweight, itch-free, and naturally temperature-regulating — the essential winter layer.", material: "100% Merino Wool", care: "Machine wash cold, lay flat to dry", sizes: ["S", "M", "L", "XL", "XXL"] },
  { id: 11, name: "Leather Belt",            price: 95,  oldPrice: null, badge: null,        badgeStyle: null,                          category: "accessories", bg: "bg-[#181410]", description: "A clean, minimalist leather belt with a brushed gold pin buckle. A finishing touch that elevates any outfit.", material: "Full-grain leather", care: "Wipe clean with dry cloth", sizes: ["S", "M", "L", "XL"] },
  { id: 12, name: "Crepe Wrap Coat",         price: 480, oldPrice: 590, badge: "Sale",       badgeStyle: "bg-[#b83a2a] text-[#f5efe6]", category: "women",       bg: "bg-[#1a1612]", description: "A wrap coat in fluid crepe with an elegant silhouette. Belted at the waist and fully lined for a polished finish.", material: "100% Polyester Crepe", care: "Dry clean only", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 13, name: "Slim Dress Trousers",     price: 220, oldPrice: null, badge: null,        badgeStyle: null,                          category: "men",         bg: "bg-[#151210]", description: "Slim-cut dress trousers with a pressed crease and side pockets. A refined foundation for both boardroom and evening wear.", material: "65% Wool, 35% Polyester", care: "Dry clean recommended", sizes: ["S", "M", "L", "XL", "XXL"] },
  { id: 14, name: "Chain Shoulder Bag",      price: 455, oldPrice: null, badge: "New",       badgeStyle: "bg-[#c9a96e] text-[#0a0806]", category: "accessories", bg: "bg-[#1c1810]", description: "A compact shoulder bag with a gold chain strap and quilted leather exterior. Small enough to keep essentials, significant enough to make a statement.", material: "Lambskin leather with gold hardware", care: "Store in dust bag when not in use", sizes: ["One Size"] },
  { id: 15, name: "Ribbed Knit Cardigan",    price: 195, oldPrice: null, badge: "Bestseller",badgeStyle: "bg-[#c9a96e] text-[#0a0806]", category: "women",       bg: "bg-[#191510]", description: "An oversized ribbed knit cardigan with deep side slits and a relaxed silhouette. The kind of piece you reach for every day.", material: "50% Wool, 50% Cotton", care: "Hand wash cold or dry clean", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 16, name: "Linen Shirt",             price: 130, oldPrice: null, badge: null,        badgeStyle: null,                          category: "men",         bg: "bg-[#171412]", description: "A relaxed linen shirt with a band collar and mother-of-pearl buttons. Designed to be worn open or tucked — effortless at any temperature.", material: "100% Linen", care: "Machine wash cold, hang dry", sizes: ["S", "M", "L", "XL", "XXL"] },
];
...
export default function ProductDetail() {
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-[#0a0806] flex flex-col items-center justify-center gap-6 pt-24 font-['Montserrat',sans-serif]">
        <p className="font-['Cormorant_Garamond',serif] text-[3rem] font-light text-[#f5efe6]">Product not found</p>
        <Link to="/shop" className="text-[0.6rem] tracking-[0.2em] uppercase text-[#c9a96e] hover:text-[#e8d5a3] transition-colors">Back to Shop</Link>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-16 px-6 sm:px-12 lg:px-20 py-12 lg:py-16">
        ...
        <div className="relative w-full aspect-[3/4] lg:aspect-auto lg:min-h-[70vh] overflow-hidden mb-10 lg:mb-0">
          <div className={`absolute inset-0 ${product.bg}`}>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-[0.55rem] tracking-[0.25em] uppercase text-[rgba(201,169,110,0.2)]">Product Image</span>
            </div>
          </div>
          {product.badge && (
            <span className={`absolute top-5 left-5 px-3 py-[6px] text-[0.5rem] font-semibold tracking-[0.18em] uppercase z-10 ${product.badgeStyle}`}>
              {product.badge}
            </span>
          )}
        ...
        <div className="flex flex-col justify-center lg:py-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[0.52rem] font-semibold tracking-[0.3em] uppercase text-[#c9a96e]">
              {product.category === "new" ? "New In" : product.category}
            </span>
          </div>

          <h1 className="font-['Cormorant_Garamond',serif] text-[2.8rem] sm:text-[3.5rem] font-light leading-[1.05] text-[#f5efe6] mb-4">
            {product.name}
          </h1>

          <div className="flex items-baseline gap-4 mb-6">
            <span className="text-[1.1rem] font-medium tracking-[0.05em] text-[#c9a96e]">${product.price.toFixed(2)}</span>
            {product.oldPrice && <span className="text-[0.85rem] text-[#9e9082] line-through">${product.oldPrice.toFixed(2)}</span>}
            {product.oldPrice && <span className="text-[0.5rem] font-semibold tracking-[0.15em] uppercase text-[#b83a2a] border border-[#b83a2a] px-2 py-[3px]">Sale</span>}
          </div>

          <p className="text-[0.7rem] leading-[2] tracking-[0.04em] text-[#9e9082] mb-8 max-w-md">
            {product.description}
          </p>
                ...
                <button key={size} onClick={() => setSelectedSize(size)}
                  className={`min-w-[2.8rem] px-3 py-2 text-[0.58rem] font-semibold tracking-[0.1em] border transition-all duration-200
                    ${selectedSize === size
                      ...
                      : "bg-transparent border-[rgba(201,169,110,0.25)] text-[#9e9082] hover:border-[#c9a96e] hover:text-[#c9a96e]"
                    }`}
                >
                  {size}
                </button>
          ...
          <div className="mt-10">
            <AccordionItem title="Material & Care">
              <strong className="text-[#e8d5a3]">Material:</strong> {product.material}<br />
              <strong className="text-[#e8d5a3]">Care:</strong> {product.care}
            </AccordionItem>
      ...
      {related.length > 0 && (
        <div className="px-6 sm:px-12 lg:px-20 py-20 border-t border-[rgba(201,169,110,0.1)]">
          <div className="flex items-center gap-4 mb-3">
            ...
            <span className="text-[0.55rem] font-semibold tracking-[0.35em] uppercase text-[#c9a96e]">You May Also Like</span>
          </div>
          <h2 className="font-['Cormorant_Garamond',serif] text-[2.5rem] font-light text-[#f5efe6] mb-12">
            Related <em className="italic text-[#e8d5a3]">Pieces</em>
          </h2>
          ...
          <div className="relative w-full max-w-lg bg-[#0d0b08] border border-[rgba(201,169,110,0.18)] z-10">
            ...
            <div className="px-8 py-6">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[rgba(201,169,110,0.12)]">
                    {["Size", "Chest", "Waist", "Hips"].map((h) => (
                      <th key={h} className="text-left pb-3 text-[0.52rem] font-semibold tracking-[0.2em] uppercase text-[#c9a96e]">{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  {sizeGuideData.map((row) => (
                    <tr key={row.size} className={`border-b border-[rgba(201,169,110,0.06)] ${selectedSize === row.size ? "bg-[rgba(201,169,110,0.06)]" : ""}`}>
                      <td className={`py-3 text-[0.62rem] font-semibold tracking-[0.08em] ${selectedSize === row.size ? "text-[#c9a96e]" : "text-[#f0e8de]"}`}>{row.size}</td>
                      <td className="py-3 text-[0.62rem] text-[#9e9082] tracking-[0.03em]">{row.chest}</td>
                      <td className="py-3 text-[0.62rem] text-[#9e9082] tracking-[0.03em]">{row.waist}</td>
                      <td className="py-3 text-[0.62rem] text-[#9e9082] tracking-[0.03em]">{row.hips}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
