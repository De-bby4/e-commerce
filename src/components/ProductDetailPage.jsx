...
const allProducts = [
  { id: 1,  name: "Silk Wrap Dress",        price: 285, oldPrice: null, badge: "New",        badgeType: "gold", category: "women",       bg: "bg-[#1c1610]", image: finieImg, description: "A fluid silk wrap dress cut for the modern woman. Designed with an adjustable tie waist and deep V-neckline, this piece transitions effortlessly from day to evening.", material: "100% Silk", care: "Dry clean only", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 2,  name: "Tailored Blazer",         price: 195, oldPrice: 320, badge: "Sale",       badgeType: "red",  category: "men",         bg: "bg-[#171310]", image: finieImg, description: "A sharp single-breasted blazer crafted from premium wool blend. Clean lapels and a structured shoulder make this a cornerstone of any refined wardrobe.", material: "80% Wool, 20% Polyester", care: "Dry clean only", sizes: ["S", "M", "L", "XL", "XXL"] },
  { id: 3,  name: "Linen Wide-Leg Trousers", price: 165, oldPrice: null, badge: null,        badgeType: null,   category: "women",       bg: "bg-[#1a1510]", image: finieImg, description: "Relaxed wide-leg trousers in breathable linen. A high-rise waist and side pockets combine comfort with elegance for warm-weather dressing.", material: "100% Linen", care: "Machine wash cold, hang dry", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 4,  name: "Cashmere Knit Midi",      price: 340, oldPrice: null, badge: "Bestseller",badgeType: "gold", category: "new",         bg: "bg-[#1e1812]", image: finieImg, description: "A luxuriously soft cashmere midi dress with ribbed knit detailing. Designed to drape beautifully, it offers warmth without compromising silhouette.", material: "100% Grade A Cashmere", care: "Hand wash cold or dry clean", sizes: ["XS", "S", "M", "L"] },
  { id: 5,  name: "Draped Satin Blouse",     price: 145, oldPrice: null, badge: "New",       badgeType: "gold", category: "new",         bg: "bg-[#191510]", image: finieImg, description: "A satin blouse with an elegant draped front and loose fit. Wear it tucked into tailored trousers or open over a slip for a layered look.", material: "95% Polyester Satin, 5% Elastane", care: "Machine wash gentle cycle", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 6,  name: "Wool Overcoat",           price: 520, oldPrice: 680, badge: "Sale",       badgeType: "red",  category: "men",         bg: "bg-[#141210]", image: finieImg, description: "A classic double-breasted overcoat in a heavy wool blend. Structured shoulders, a clean back vent, and a full lining make this the definitive winter coat.", material: "70% Wool, 20% Polyamide, 10% Cashmere", care: "Dry clean only", sizes: ["S", "M", "L", "XL"] },
  { id: 7,  name: "Pleated Midi Skirt",      price: 210, oldPrice: null, badge: null,        badgeType: null,   category: "women",       bg: "bg-[#1b1612]", image: finieImg, description: "A flowing pleated midi skirt with a hidden side zip. The movement of the fabric creates an effortlessly graceful silhouette for any occasion.", material: "100% Viscose", care: "Dry clean recommended", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 8,  name: "Structured Tote Bag",     price: 390, oldPrice: null, badge: "Bestseller",badgeType: "gold", category: "accessories", bg: "bg-[#171310]", image: finieImg, description: "A minimal structured tote in full-grain leather. Spacious enough for daily essentials with an interior zip pocket and magnetic closure.", material: "Full-grain leather", care: "Wipe clean with dry cloth", sizes: ["One Size"] },
  { id: 9,  name: "Velvet Evening Gown",     price: 620, oldPrice: null, badge: "New",       badgeType: "gold", category: "women",       bg: "bg-[#1d1612]", image: finieImg, description: "A floor-length velvet gown with a fitted bodice and sweeping skirt. Crafted for evenings that demand presence.", material: "90% Polyester Velvet, 10% Elastane", care: "Dry clean only", sizes: ["XS", "S", "M", "L"] },
  { id: 10, name: "Merino Turtleneck",       price: 175, oldPrice: null, badge: null,        badgeType: null,   category: "men",         bg: "bg-[#161412]", image: finieImg, description: "A slim-fit turtleneck in superfine merino wool. Lightweight, itch-free, and naturally temperature-regulating — the essential winter layer.", material: "100% Merino Wool", care: "Machine wash cold, lay flat to dry", sizes: ["S", "M", "L", "XL", "XXL"] },
  { id: 11, name: "Leather Belt",            price: 95,  oldPrice: null, badge: null,        badgeType: null,   category: "accessories", bg: "bg-[#181410]", image: finieImg, description: "A clean, minimalist leather belt with a brushed gold pin buckle. A finishing touch that elevates any outfit.", material: "Full-grain leather", care: "Wipe clean with dry cloth", sizes: ["S", "M", "L", "XL"] },
  { id: 12, name: "Crepe Wrap Coat",         price: 480, oldPrice: 590, badge: "Sale",       badgeType: "red",  category: "women",       bg: "bg-[#1a1612]", image: finieImg, description: "A wrap coat in fluid crepe with an elegant silhouette. Belted at the waist and fully lined for a polished finish.", material: "100% Polyester Crepe", care: "Dry clean only", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 13, name: "Slim Dress Trousers",     price: 220, oldPrice: null, badge: null,        badgeType: null,   category: "men",         bg: "bg-[#151210]", image: finieImg, description: "Slim-cut dress trousers with a pressed crease and side pockets. A refined foundation for both boardroom and evening wear.", material: "65% Wool, 35% Polyester", care: "Dry clean recommended", sizes: ["S", "M", "L", "XL", "XXL"] },
  { id: 14, name: "Chain Shoulder Bag",      price: 455, oldPrice: null, badge: "New",       badgeType: "gold", category: "accessories", bg: "bg-[#1c1810]", image: finieImg, description: "A compact shoulder bag with a gold chain strap and quilted leather exterior. Small enough to keep essentials, significant enough to make a statement.", material: "Lambskin leather with gold hardware", care: "Store in dust bag when not in use", sizes: ["One Size"] },
  { id: 15, name: "Ribbed Knit Cardigan",    price: 195, oldPrice: null, badge: "Bestseller",badgeType: "gold", category: "women",       bg: "bg-[#191510]", image: finieImg, description: "An oversized ribbed knit cardigan with deep side slits and a relaxed silhouette. The kind of piece you reach for every day.", material: "50% Wool, 50% Cotton", care: "Hand wash cold or dry clean", sizes: ["XS", "S", "M", "L", "XL"] },
  { id: 16, name: "Linen Shirt",             price: 130, oldPrice: null, badge: null,        badgeType: null,   category: "men",         bg: "bg-[#171412]", image: finieImg, description: "A relaxed linen shirt with a band collar and mother-of-pearl buttons. Designed to be worn open or tucked — effortless at any temperature.", material: "100% Linen", care: "Machine wash cold, hang dry", sizes: ["S", "M", "L", "XL", "XXL"] },
];
  ...
  return (
    <div className="group flex flex-col cursor-pointer">
      <div className={`relative w-full aspect-[3/4] overflow-hidden ${product.bg}`}>
        ...
        <img src={product.image} alt={product.name} className="absolute inset-0 w-full h-full object-cover" style={{ objectPosition: "center 20%" }} />
        {product.badge && (
